...
filepath = 'D:/Plant-Leaf-Disease-Prediction-main/Plant-Leaf-Disease-Prediction-main/model.h5'
...
def pred_tomato_dieas(tomato_plant):
  ...
  if pred==0:
      ...
      return "other leaf images", 'other leaf.html'
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join('D:/Plant-Leaf-Disease-Prediction-main/Plant-Leaf-Disease-Prediction-main/static/upload/', filename)
        file.save(file_path)
